...
import { useEditCategoryMutation } from '../../../services/adminApi';

const ModalEditCategory = ({handleEdit,item}) => {
  const [editCategory,{error}]=useEditCategoryMutation()
    const [form,setForm]=useState({
      ...
      const handleSubmit=async(e)=>{
        ...
        //  const updatedData={
        //   ...categoryList[indexOfEdit],
        //   category:form.category,
        //   description:form.description
        //  }
        //  updatedList[indexOfEdit]=updatedData
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
          ...
          >
            ...
            <h2 className="text-2xl font-bold mb-6 text-center text-white">Edit CATEGORIES</h2>
